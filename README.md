...
java -Xmx2g -Xms512m -jar target/logfile-analyzer-0.0.1-SNAPSHOT.jar

# With custom port
java -jar target/logfile-analyzer-0.0.1-SNAPSHOT.jar --server.port=8080
```
...
java -Xmx1g -Xms256m -jar target/logfile-analyzer-0.0.1-SNAPSHOT.jar

# Large files (>100MB)
java -Xmx4g -Xms1g -jar target/logfile-analyzer-0.0.1-SNAPSHOT.jar
```
